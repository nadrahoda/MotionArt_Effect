    ...
    return (function (e) {
      ...
      function (e, r, n) {
        ...
        var o = {
          ...
          threshold: 0.6,
          soft_knee: 0.7,
          background_color: { r: 13, g: 5, b: 31 },
          transparent: !1
        }
        r.behavior = o
        r.DRAWING_PARAMS = {
        ...
        Object.defineProperty(r, '__esModule', { value: !0 }),
          ...
          (r.activator = function (e, r, n, o, a) {
            ...
            function w (n) {
              R.render_bloom &&
                ...
                null != n && R.transparent
                  ? r.disable(r.BLEND)
                  : (r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA), r.enable(r.BLEND))
            ...
            e.addEventListener('mousemove', function (e) {
              a[0].moved = true;  // Always set moved to true on mouse move
            ...
            e.addEventListener('mousedown', function () {
              a[0].down = true;  // Keep this if other functionalities depend on mouse down
              a[0].color = L();  // Function to generate color or other effect
            })
              =window.addEventListener('mouseup', function () {
                  a[0].down = false;  // Keep this if other functionalities depend on mouse up
                })
